...
?>
	<section class="article-content">
		<div class="container">
			...
			<!-- PARTAGE ARTICLE -->
			<div class="share-article col-xs-12 col-sm-12 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
	...
	<section class="article-content">
        <div class="container">
                ...
                <p class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
                        J'ai d'autres souvenirs de Charles, significatifs de son caractère. Enfants, nous allions toujours l'été à Wimille, près de Wimereux, aux environs de Boulogne-sur-Mer, à deux ou trois kilo¬mètres de la mer. Ma grand-mère maternelle louait alors une maison où, avec mes cousins, nous passions nos grandes vacances. Il y avait un portique au milieu d'une prairie. Le matin, c'était à qui retiendrait le premier la balançoire. Le premier cri que l'on entendait, aussitôt le réveil, était toujours celui de Charles : « J'y suis, je retiens la 
                </p>
                <p class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
                ...
                <div class="col-xs-11 col-xs-offset-1 col-sm-11 col-sm-offset-1 col-md-offset-3 col-md-7 col-lg-offset-3 col-lg-7">
                        <ul class="dialog">
                                <li>- Maman, je voudrais monter à poney!</li>
                                <li>- Non, tu es monté hier. Tu ne monteras pas aujourd'hui.</li>
                                <li>- Alors, je vais être méchant!</li>
                        </ul>
                </div>
                <img class="float-both col-xs-12" src="../images/charles2.png" alt="">
                <p class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
                ...
                <div class="col-xs-11 col-xs-offset-1 col-sm-11 col-sm-offset-1 col-md-offset-3 col-md-7 col-lg-offset-3 col-lg-7">
                        <ul class="dialog">
                                <li>- Charles, tu es sage?</li>
                                <li>- Oui, papa.</li>
                                <li>- Tu n'opprimes pas Jacques?</li>
                                <li>- Non papa.</li>
                                <li>- Ni Pierre ?</li>
                                <li>- Non papa.</li>
                                <li>- Tiens, voilà deux sous pour que tu continues à être gentil avec tes frères.</li>
                        </ul>
                </div>
                <p class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
                ...
                <p class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
                        Charles enfant, poursuit Madame Cailliau, était très aimé des domestiques. D'ailleurs, il n'oublia jamais, au cours de sa vie, celles qui s'occu¬pèrent de lui pen¬dant son enfance. Il lui arriva de leur témoigner sa fidélité et sa reconnaissance. Après la guerre, au temps du RPF, je me souviens que, passant pas Coutances, il rendit visite à Célestine, notre bonne quand nous étions enfants. Elle m'avait écrit après: « Le Général m'a embrassée... ». Nous avions une demoiselle qui nous apprenait le piano, Mlle Monteil (Charles n'avait jamais beau¬coup travaillé son piano). Quand il est arrivé à Matignon.
                </p>
                <blockquote class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
                        Xavier était le roi d'Angleterre et commandait les troupes anglaises. Jean de Corbie, notre cousin, était empereur de Russie, à la tête des troupes russes. Charles était toujours le roi de France.
                </blockquote>
                <p class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
                        Charles aimait tous les jeux : le diabolo, le croquet, le cerf-volant, le bal¬lon, colin-maillard. Il jouait beaucoup aussi aux soldats de plomb avec ses frères. Xavier était le roi d'Angleterre et commandait les troupes anglai¬ses. Jean de Corbie, notre cousin, était empereur de Russie, à la tête des troupes russes. Charles était toujours le roi de France. Il avait toujours sous ses ordres l'armée française. Il n'était pas question qu'il en fût autrement. Pierre et Jacques étaient alors trop petits pour jouer. Charles interpellait Jacques : « Toi, tu es le roi de l'île mystérieuse ! » (dans le livre de Jules Vernes, nous rêvions des heures entières sur la carte de l'île). Et Pierre: « Tu es le Pape et tu commandes aux gardes pontificaux ! ». Charles ne prenait pas ses frères cadets au sérieux, mais c'est pour qu'ils n'aient pas de chagrin qu'il les bombardait d'un titre.
                </p>
                ...
                <div class="share-article col-xs-12 col-sm-12 col-md-offset-2 col-md-8 col-lg-offset-2 col-lg-8">
                        <a href="" class="btn-simple btn-animate icon-facebook">
                                <span class="icon-facebook"></span>
                        </a>
                        <a href="" class="btn-simple btn-animate icon-twitter">
                            <span class="icon-twitter"></span>
                        </a>
                </div>
        </div>
